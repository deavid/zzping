...
///
/// This struct contains the essential data from a completed ping, including the
/// authoritative timestamp generated by the Pinger.
#[derive(Debug, Clone, PartialEq)]
pub struct PingResult {
    /// The sequence number of the ping, used for correlation.
    pub sequence_idx: u16,
    /// The absolute, monotonic, wall-clock time at which the ping was sent.
