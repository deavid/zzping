...
async fn test_ingestion_logic() {
    ...
    let successful_ping = PingResult {
        sequence_idx: 1,
        sent_nanos: 1000,
...
async fn test_send_batch_ok_and_embargo() {
    ...
    submitter.ingest_ping_result(PingResult {
        sequence_idx: 1,
        sent_nanos: 1000,
        rtt: Some(Duration::from_millis(50)),
    });
...
async fn test_send_batch_desync() {
    ...
    let new_acked_nanos = 5000;
    {
        ...
        *response = SendBatchResponse {
            ...
            database_confirms_last_acked_nanos: new_acked_nanos,
        };
    }
    let server_addr = common::spawn_mock_server(mock_service.clone()).await;
    let db_client =
    ...
    let final_acked_nanos = 10050;
    {
        ...
        *response = SendBatchResponse {
            ...
            database_confirms_last_acked_nanos: final_acked_nanos,
        };
    }
    ...
    assert_eq!(
        received_batches[1].collector_believes_last_acked_nanos, new_acked_nanos,
